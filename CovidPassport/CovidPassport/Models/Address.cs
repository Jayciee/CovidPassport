...
namespace CovidPassport
{
    public partial class Address
    {
        ...
        [StringLength(8)]
        [RegularExpression(@"[A-Z0-9]{3,4}\s[A-Z0-9]{3}",ErrorMessage = "Invalid postcode. Correct format should be in [XXXX XXX] or [XXX XXX]. Make sure there are no Special symbols or characters")]
